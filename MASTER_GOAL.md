# MASTER_GOAL.md — ask-github

## Purpose

This is the **master goal** for building ask-github. It does not implement the gem
directly. It loads and follows the detailed build plan at:

> **GOAL.md:** `/Users/kaka/Code/ask-rb/ask-github/GOAL.md`
...
- **Source:** `/Users/kaka/Code/ask-rb/ask-github/lib/`
- **Tests:** `/Users/kaka/Code/ask-rb/ask-github/test/`
- **Goal:** `/Users/kaka/Code/ask-rb/ask-github/GOAL.md`
- **Remote:** `git@github.com:ask-rb/ask-github.git`

## Dependencies
This gem depends on:
- [ ] ask-auth v0.1.0 (provides Ask::Auth.resolve)

## Build Steps (Outline)

The GOAL.md at `/Users/kaka/Code/ask-rb/ask-github/GOAL.md` contains the full
...
See the bottom of `/Users/kaka/Code/ask-rb/ask-github/GOAL.md` for the full checklist.
